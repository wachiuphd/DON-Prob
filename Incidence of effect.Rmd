...
incBMR5 <- ggplot(incBMRconf)+
  ...
  theme_bw()+
  coord_cartesian(xlim=c(1e-5,1),ylim=c(0,1))+
  scale_x_log10()+
  theme(text = element_text(size = 12))+
  geom_vline(xintercept=0.00258, linetype="dashed", color="red")
print(incBMR5)
...
incBMR5.log <- ggplot(incBMRconf)+
  ...
  xlab("DON dose (mg/kg-d)")+ylab("Population Incidence of 5% Decrease in Body Weight")+
  theme_bw()+
  coord_cartesian(xlim=c(1e-5,1),ylim=c(1e-6,1))+
  scale_x_log10()+
  scale_y_log10()+
  theme(text = element_text(size = 12))+
  geom_vline(xintercept=0.00258, linetype="dashed", color="red")+
  geom_point(aes(x=0.00258, y=1e-2), color="red", size=3, shape=15)
print(incBMR5.log)
```
...
incBMR5.be <- ggplot(incBMRconf)+
  ...
  scale_x_log10()+
  theme(text = element_text(size = 12))+
  geom_vline(xintercept=0.00183, linetype="dashed", color="red")+
  geom_vline(xintercept=2.424251e-05, linetype="dotted", color="yellow")+
  geom_vline(xintercept=7.271856e-04, linetype="dotted", color="yellow")+
  geom_vline(xintercept=1.338540e-04, linetype="solid", color="yellow")+
  geom_rect(aes(xmin=2.424251e-05, xmax=7.271856e-04,ymin=1e-7,ymax=Inf), fill="yellow", alpha= 0.005)+
  ...
  geom_vline(xintercept=5.206034e-12, linetype="dotted", color="green")+
  geom_vline(xintercept=1.546008e-04, linetype="dotted", color="green")+
  geom_vline(xintercept=2.894175e-08, linetype="solid", color="green")+
  geom_rect(aes(xmin=5.206034e-12, xmax=1.546008e-04,ymin=1e-7,ymax=Inf), fill="green", alpha= 0.005)
print(incBMR5.be)
...
incBMR5.be.log <- ggplot(incBMRconf)+
  ...
  xlab("Urinary biomonitoring equivalent (mg/kg-d)")+ylab("Population Incidence of 5% Decrease in Body Weight")+
  theme_bw()+
  coord_cartesian(xlim=c(1e-5,1),ylim=c(1e-5,1))+
  scale_x_log10()+
  scale_y_log10()+
  theme(text = element_text(size = 12))+
  geom_vline(xintercept=0.00183, linetype="dashed", color="red")+
  geom_point(aes(x=0.00183, y=1e-2), color="red", size=3, shape=15)+
  geom_vline(xintercept=2.424251e-05, linetype="dotted", color="yellow")+
  geom_vline(xintercept=7.271856e-04, linetype="dotted", color="yellow")+
  geom_vline(xintercept=1.338540e-04, linetype="solid", color="yellow")+
  geom_rect(aes(xmin=2.424251e-05, xmax=7.271856e-04,ymin=1e-7,ymax=Inf), fill="yellow", alpha= 0.005)+
  ...
  geom_vline(xintercept=2.894175e-08, linetype="solid", color="green")+
  geom_rect(aes(xmin=5.206034e-12, xmax=1.546008e-04,ymin=1e-7,ymax=Inf), fill="green", alpha= 0.005)
  #geom_vline(xintercept=7.694330e-07, linetype="dotted", color="darkblue")+
  #geom_vline(xintercept=7.155839e-04, linetype="dotted", color="darkblue")+
  #geom_vline(xintercept=2.436855e-05, linetype="solid", color="darkblue")+
  #geom_rect(aes(xmin=7.694330e-07, xmax=7.155839e-04,ymin=1e-7,ymax=Inf), fill="darkblue", alpha= 0.005)
...
incBMR5.b_be <- ggplot(b_incBMRconf)+
  ...
  scale_x_log10()+
  theme(text = element_text(size = 12))+
  geom_vline(xintercept=0.00031, linetype="dashed", color="red")+
  geom_vline(xintercept=1.969793e-05, linetype="dotted", color="orange")+
  geom_vline(xintercept=1.543985e-03, linetype="dotted", color="orange")+
  geom_vline(xintercept=1.752785e-04, linetype="solid", color="orange")+
  geom_rect(aes(xmin=1.969793e-05, xmax=1.543985e-03,ymin=1e-7,ymax=Inf), fill="orange", alpha= 0.005)+
  geom_vline(xintercept=5.164453e-07, linetype="dotted", color="green")+
  geom_vline(xintercept=3.022349e-04, linetype="dotted", color="green")+
  geom_vline(xintercept=1.294155e-05, linetype="solid", color="green")+
  geom_rect(aes(xmin=5.164453e-07, xmax=3.022349e-04,ymin=1e-7,ymax=Inf), fill="green", alpha= 0.005)
print(incBMR5.b_be)
...
incBMR5.b_be.log <- ggplot(b_incBMRconf)+
  ...
  xlab("Blood biomonitoring equivalent (mg/L)")+ylab("Population Incidence of 5% Decrease in Body Weight")+
  theme_bw()+
  coord_cartesian(xlim=c(1e-5,1),ylim=c(1e-3,1))+
  scale_x_log10()+
  scale_y_log10()+
  theme(text = element_text(size = 12))+
  geom_vline(xintercept=0.00031, linetype="dashed", color="red")+
  geom_point(aes(x=0.00031, y=1e-2), color="red", size=3, shape=15)+
  geom_vline(xintercept=1.969793e-05, linetype="dotted", color="orange")+
  geom_vline(xintercept=1.543985e-03, linetype="dotted", color="orange")+
  geom_vline(xintercept=1.752785e-04, linetype="solid", color="orange")+
  geom_rect(aes(xmin=1.969793e-05, xmax=1.543985e-03,ymin=1e-7,ymax=Inf), fill="orange", alpha= 0.005)+
...
ggsave("Log scale Population Incidence of 5percent Decrease in Body Weight.pdf", plot=popincidence, scale=0.5, width=30, height=10)
```
...
percchange <- ggarrange(bwchange, expboxplot, nrow=1, ncol=2, labels = c("A","B"), font.label = list(size = 18))
