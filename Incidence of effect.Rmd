...
incBMR5.be.log <- ggplot(incBMRconf)+
  ...
  geom_point(aes(x=7.170922e-04, y=4.6e-03), color="darkgreen", size=3, shape=9)+
  geom_segment(aes(x=1.346428e-04,y=4.6e-03/2,xend=1.346428e-04,yend=4.6e-03*2),color="darkgreen",linetype="solid")+
  geom_rect(aes(xmin=2.508499e-05, xmax=7.170922e-04,ymin=4.6e-03/2,ymax=4.6e-03*2), fill="darkgreen", alpha= 0.005)+ #ymax=y*2; ymin=y/2
