...
ggplot(incBMRconf)+
  ...
  xlab("Dose")+ylab("Incidence")+
  coord_cartesian(xlim=c(1e-3,1),ylim=c(0,1))+scale_x_log10()
...
ggplot(incBMRconf)+
  ...
  geom_line(aes(x=d_H,y=`95%`),linetype="dotted",alpha=0.5)+
  xlab("Dose")+ylab("Incidence")+
  coord_cartesian(xlim=c(1e-3,1),ylim=c(1e-4,1))+scale_x_log10()+scale_y_log10()
...
ggplot(yconf.df)+
  ...
  xlab("Dose")+ylab("Fractional Change")+
